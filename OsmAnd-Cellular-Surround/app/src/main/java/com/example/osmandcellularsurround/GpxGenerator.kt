...
object GpxGenerator {
    ...
    fun generateGpx(context: Context, mainTower: CellTower?, surroundingTowers: List<CellTower>): Uri {
        ...
        gpxStr.append("      <group name=\"main_tower\" icon=\"tower_communications\" background=\"circle\" color=\"#00FF00\" />\n")
        gpxStr.append("      <group name=\"surrounding_tower\" icon=\"tower_communications\" background=\"circle\" color=\"#0000FF\" />\n")
        gpxStr.append("    </osmand:points_groups>\n")
        gpxStr.append("  </extensions>\n")
